...
"}")
        ...
        self.tweaksPageBtn = QToolButton(self.sidebar)
        self.tweaksPageBtn.setObjectName(u"tweaksPageBtn")
        sizePolicy2.setHeightForWidth(self.tweaksPageBtn.sizePolicy().hasHeightForWidth())
        self.tweaksPageBtn.setSizePolicy(sizePolicy2)
        self.tweaksPageBtn.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon8 = QIcon()
        icon8.addFile(u":/icon/ellipsis.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.tweaksPageBtn.setIcon(icon8)
        self.tweaksPageBtn.setCheckable(True)
        self.tweaksPageBtn.setAutoExclusive(True)
        self.tweaksPageBtn.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)
        self.tweaksPageBtn.setProperty(u"cls", u"sidebarBtn")

        self.verticalLayout.addWidget(self.tweaksPageBtn)
...
"}")
        icon14 = QIcon()
        icon14.addFile(u":/icon/github.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.mainDevBtn.setIcon(icon14)
...
"    color: #FFFFFF;\n"
"}")
        self.leminGithubBtn.setIcon(icon14)
...
"    color: #FFFFFF;\n"
"}")
        self.wind0ws11AeroBtn.setIcon(icon14)
...
"    border-radius: 0px;\n"
"}")
        self.toolButton_81.setIcon(icon6)
        ...
        self.horizontalLayout_51.addItem(self.horizontalSpacer_43)
...
"}")
        icon19 = QIcon()
        icon19.addFile(u":/icon/app-indicator.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButton_7.setIcon(icon19)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.footnoteLbl.sizePolicy().hasHeightForWidth())
        self.footnoteLbl.setSizePolicy(sizePolicy5)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.autoLockLbl.sizePolicy().hasHeightForWidth())
        self.autoLockLbl.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.lockScreenAutoLockLabel.sizePolicy().hasHeightForWidth())
        self.lockScreenAutoLockLabel.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.lockScreenAutoLockValueLabel.sizePolicy().hasHeightForWidth())
        self.lockScreenAutoLockValueLabel.setSizePolicy(sizePolicy5)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.airdropTimeLimitContent.sizePolicy().hasHeightForWidth())
        self.airdropTimeLimitContent.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.disableLockRespringContent.sizePolicy().hasHeightForWidth())
        self.disableLockRespringContent.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.disableDimmingContent.sizePolicy().hasHeightForWidth())
        self.disableDimmingContent.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.lowBatteryAlertsContent.sizePolicy().hasHeightForWidth())
        self.lowBatteryAlertsContent.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.hideACPowerContent.sizePolicy().hasHeightForWidth())
        self.hideACPowerContent.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.disableCrumbContent.sizePolicy().hasHeightForWidth())
        self.disableCrumbContent.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.supervisionTextContent.sizePolicy().hasHeightForWidth())
        self.supervisionTextContent.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.showDIInScreenshotsContent.sizePolicy().hasHeightForWidth())
        self.showDIInScreenshotsContent.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.hideDICompletelyContent.sizePolicy().hasHeightForWidth())
        self.hideDICompletelyContent.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.enableAirPlayContent.sizePolicy().hasHeightForWidth())
        self.enableAirPlayContent.setSizePolicy(sizePolicy5)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.authEngUIContent.sizePolicy().hasHeightForWidth())
        self.authEngUIContent.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.floatingTabBarContent.sizePolicy().hasHeightForWidth())
        self.floatingTabBarContent.setSizePolicy(sizePolicy5)
        ...
        self.horizontalLayout_20 = QHBoxLayout(self.horizontalWidget_17)
        self.horizontalLayout_20.setSpacing(10)
        self.horizontalLayout_20.setObjectName(u"horizontalLayout_20")
        self.horizontalLayout_20.setContentsMargins(0, 9, 0, 9)
        self.toolButton_10 = QToolButton(self.horizontalWidget_17)
...
"}")
        icon20 = QIcon()
        icon20.addFile(u":/icon/hdd.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButton_10.setIcon(icon20)
        ...
        self.verticalLayout_12 = QVBoxLayout(self.verticalWidget_17)
        ...
        self.horizontalLayout_20.addWidget(self.verticalWidget_17)
        ...
        self.verticalLayout_14.addWidget(self.horizontalWidget_17)
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.scrollAreaWidgetContents3.sizePolicy().hasHeightForWidth())
        self.scrollAreaWidgetContents3.setSizePolicy(sizePolicy6)
        ...
        sizePolicy5.setHeightForWidth(self.buildVersionContent.sizePolicy().hasHeightForWidth())
        self.buildVersionContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.buildVersionContent)

        self.RTLContent = QWidget(self.internalOptionsPageContent)
        self.RTLContent.setObjectName(u"RTLContent")
        sizePolicy5.setHeightForWidth(self.RTLContent.sizePolicy().hasHeightForWidth())
        self.RTLContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.RTLContent)

        self.LTRContent = QWidget(self.internalOptionsPageContent)
        self.LTRContent.setObjectName(u"LTRContent")
        sizePolicy5.setHeightForWidth(self.LTRContent.sizePolicy().hasHeightForWidth())
        self.LTRContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.LTRContent)
        ...
        sizePolicy5.setHeightForWidth(self.sbIconVisibilityContent.sizePolicy().hasHeightForWidth())
        self.sbIconVisibilityContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.sbIconVisibilityContent)

        self.keyFlickContent = QWidget(self.internalOptionsPageContent)
        self.keyFlickContent.setObjectName(u"keyFlickContent")
        sizePolicy5.setHeightForWidth(self.keyFlickContent.sizePolicy().hasHeightForWidth())
        self.keyFlickContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.keyFlickContent)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.disableSecondsHandContent.sizePolicy().hasHeightForWidth())
        self.disableSecondsHandContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.disableSecondsHandContent)
        ...
        sizePolicy5.setHeightForWidth(self.searchDisabledDomainsContent.sizePolicy().hasHeightForWidth())
        self.searchDisabledDomainsContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.searchDisabledDomainsContent)
        ...
        sizePolicy5.setHeightForWidth(self.hintsVisibleContent.sizePolicy().hasHeightForWidth())
        self.hintsVisibleContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.hintsVisibleContent)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.metalHUDContent.sizePolicy().hasHeightForWidth())
        self.metalHUDContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.metalHUDContent)

        self.iMessageContent = QWidget(self.internalOptionsPageContent)
        self.iMessageContent.setObjectName(u"iMessageContent")
        sizePolicy5.setHeightForWidth(self.iMessageContent.sizePolicy().hasHeightForWidth())
        self.iMessageContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.iMessageContent)

        self.IDSContent = QWidget(self.internalOptionsPageContent)
        self.IDSContent.setObjectName(u"IDSContent")
        sizePolicy5.setHeightForWidth(self.IDSContent.sizePolicy().hasHeightForWidth())
        self.IDSContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.IDSContent)

        self.VCContent = QWidget(self.internalOptionsPageContent)
        self.VCContent.setObjectName(u"VCContent")
        sizePolicy5.setHeightForWidth(self.VCContent.sizePolicy().hasHeightForWidth())
        self.VCContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.VCContent)
        ...
        sizePolicy5.setHeightForWidth(self.accessoryDevContent.sizePolicy().hasHeightForWidth())
        self.accessoryDevContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.accessoryDevContent)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.appStoreContent.sizePolicy().hasHeightForWidth())
        self.appStoreContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.appStoreContent)

        self.notesContent = QWidget(self.internalOptionsPageContent)
        self.notesContent.setObjectName(u"notesContent")
        sizePolicy5.setHeightForWidth(self.notesContent.sizePolicy().hasHeightForWidth())
        self.notesContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.notesContent)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.showTouchesContent.sizePolicy().hasHeightForWidth())
        self.showTouchesContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.showTouchesContent)
        ...
        sizePolicy5.setHeightForWidth(self.hideRespringContent.sizePolicy().hasHeightForWidth())
        self.hideRespringContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.hideRespringContent)
        ...
        sizePolicy5.setHeightForWidth(self.wakeVibrateContent.sizePolicy().hasHeightForWidth())
        self.wakeVibrateContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.wakeVibrateContent)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.pasteSoundContent.sizePolicy().hasHeightForWidth())
        self.pasteSoundContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.pasteSoundContent)
        ...
        sizePolicy5.setHeightForWidth(self.notifyPastesContent.sizePolicy().hasHeightForWidth())
        self.notifyPastesContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_13.addWidget(self.notifyPastesContent)
        ...
        self.verticalLayout_14.addWidget(self.internalOptionsScrollArea)
        ...
        self.verticalLayout_141 = QVBoxLayout(self.liquidGlassPage)
        ...
        self.horizontalLayout_201 = QHBoxLayout(self.horizontalWidget_18)
        ...
        self.toolButton_101 = QToolButton(self.horizontalWidget_18)
...
"}")
        icon21 = QIcon()
        icon21.addFile(u":/icon/liquid-glass.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.verticalLayout_121 = QVBoxLayout(self.verticalWidget_18)
        ...
        self.verticalLayout_121.addWidget(self.liquidGlassLbl)

        self.verticalSpacer_181 = QSpacerItem(20, 16, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.verticalLayout_121.addItem(self.verticalSpacer_181)


        self.horizontalLayout_201.addWidget(self.verticalWidget_18)
        ...
        self.verticalLayout_141.addWidget(self.horizontalWidget_18)

        self.line_121 = QFrame(self.liquidGlassPage)
...
"}")
        ...
        self.verticalLayout_131 = QVBoxLayout(self.liquidGlassPageContent)
        ...
        sizePolicy5.setHeightForWidth(self.forceSolariumFallbackContent.sizePolicy().hasHeightForWidth())
        self.forceSolariumFallbackContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_131.addWidget(self.forceSolariumFallbackContent)
        ...
        sizePolicy5.setHeightForWidth(self.disableSolariumContent.sizePolicy().hasHeightForWidth())
        self.disableSolariumContent.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.ignoreSolariumAppBuildContent.sizePolicy().hasHeightForWidth())
        self.ignoreSolariumAppBuildContent.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.noLiquidClockContent.sizePolicy().hasHeightForWidth())
        self.noLiquidClockContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_131.addWidget(self.noLiquidClockContent)

        self.noLiquidDockContent = QWidget(self.liquidGlassPageContent)
        self.noLiquidDockContent.setObjectName(u"noLiquidDockContent")
        sizePolicy5.setHeightForWidth(self.noLiquidDockContent.sizePolicy().hasHeightForWidth())
        self.noLiquidDockContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_131.addWidget(self.noLiquidDockContent)
        ...
        sizePolicy5.setHeightForWidth(self.disableSpecularContent.sizePolicy().hasHeightForWidth())
        self.disableSpecularContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_131.addWidget(self.disableSpecularContent)
        ...
        sizePolicy5.setHeightForWidth(self.disableOuterRefractionContent.sizePolicy().hasHeightForWidth())
        self.disableOuterRefractionContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_131.addWidget(self.disableOuterRefractionContent)
        ...
        sizePolicy5.setHeightForWidth(self.disableSolariumHDRContent.sizePolicy().hasHeightForWidth())
        self.disableSolariumHDRContent.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_131.addWidget(self.disableSolariumHDRContent)
        ...
        self.verticalLayout_661 = QVBoxLayout(self.disallowGlassButtonsContent)
        self.verticalLayout_661.setObjectName(u"verticalLayout_661")
        self.verticalLayout_661.setContentsMargins(0, 0, 0, 0)
        self.label_651 = QLabel(self.disallowGlassButtonsContent)
        self.label_651.setObjectName(u"label_651")

        self.verticalLayout_661.addWidget(self.label_651)

        self.disallowGlassButtonsBtns = QHBoxLayout()
        self.disallowGlassButtonsBtns.setObjectName(u"disallowGlassButtonsBtns")

        self.verticalLayout_661.addLayout(self.disallowGlassButtonsBtns)


        self.verticalLayout_131.addWidget(self.disallowGlassButtonsContent)
        ...
        self.verticalLayout_671 = QVBoxLayout(self.disallowGlassLockScreenContent)
        self.verticalLayout_671.setObjectName(u"verticalLayout_671")
        self.verticalLayout_671.setContentsMargins(0, 0, 0, 0)
        self.label_661 = QLabel(self.disallowGlassLockScreenContent)
        self.label_661.setObjectName(u"label_661")

        self.verticalLayout_671.addWidget(self.label_661)

        self.disallowGlassLockScreenBtns = QHBoxLayout()
        self.disallowGlassLockScreenBtns.setObjectName(u"disallowGlassLockScreenBtns")

        self.verticalLayout_671.addLayout(self.disallowGlassLockScreenBtns)


        self.verticalLayout_131.addWidget(self.disallowGlassLockScreenContent)
        ...
        self.verticalLayout_681 = QVBoxLayout(self.forceEnhancedSpecularsContent)
        self.verticalLayout_681.setObjectName(u"verticalLayout_681")
        self.verticalLayout_681.setContentsMargins(0, 0, 0, 0)
        self.label_67 = QLabel(self.forceEnhancedSpecularsContent)
        self.label_67.setObjectName(u"label_67")

        self.verticalLayout_681.addWidget(self.label_67)

        self.forceEnhancedSpecularsBtns = QHBoxLayout()
        self.forceEnhancedSpecularsBtns.setObjectName(u"forceEnhancedSpecularsBtns")

        self.verticalLayout_681.addLayout(self.forceEnhancedSpecularsBtns)


        self.verticalLayout_131.addWidget(self.forceEnhancedSpecularsContent)
        ...
        self.verticalLayout_131.addWidget(self.forceSolariumIntelligenceContent)
        ...
        self.verticalLayout_701 = QVBoxLayout(self.uiSolariumFallbackContent)
        self.verticalLayout_701.setObjectName(u"verticalLayout_701")
        self.verticalLayout_701.setContentsMargins(0, 0, 0, 0)
        self.label_69 = QLabel(self.uiSolariumFallbackContent)
        self.label_69.setObjectName(u"label_69")

        self.verticalLayout_701.addWidget(self.label_69)

        self.uiSolariumFallbackBtns = QHBoxLayout()
        self.uiSolariumFallbackBtns.setObjectName(u"uiSolariumFallbackBtns")

        self.verticalLayout_701.addLayout(self.uiSolariumFallbackBtns)


        self.verticalLayout_131.addWidget(self.uiSolariumFallbackContent)
        ...
        self.verticalLayout_711 = QVBoxLayout(self.ignoreSolariumHardwareCheckContent)
        self.verticalLayout_711.setObjectName(u"verticalLayout_711")
        self.verticalLayout_711.setContentsMargins(0, 0, 0, 0)
        self.label_70 = QLabel(self.ignoreSolariumHardwareCheckContent)
        self.label_70.setObjectName(u"label_70")

        self.verticalLayout_711.addWidget(self.label_70)
        ...
        self.verticalLayout_711.addLayout(self.ignoreSolariumHardwareCheckBtns)


        self.verticalLayout_131.addWidget(self.ignoreSolariumHardwareCheckContent)
        ...
        self.verticalLayout_131.addWidget(self.ignoreSolariumOptOutContent)
        ...
        self.verticalLayout_731 = QVBoxLayout(self.disableSpecularEverywhereContent)
        self.verticalLayout_731.setObjectName(u"verticalLayout_731")
        self.verticalLayout_731.setContentsMargins(0, 0, 0, 0)
        self.label_72 = QLabel(self.disableSpecularEverywhereContent)
        self.label_72.setObjectName(u"label_72")

        self.verticalLayout_731.addWidget(self.label_72)
        ...
        self.verticalLayout_731.addLayout(self.disableSpecularEverywhereBtns)


        self.verticalLayout_131.addWidget(self.disableSpecularEverywhereContent)
        ...
        self.verticalLayout_141.addWidget(self.liquidGlassScrollArea)
        ...
        self.verticalLayout_142.addWidget(self.daemonsScrollArea)
        ...
        self.horizontalLayout_202 = QHBoxLayout(self.horizontalWidget_7)
        self.horizontalLayout_202.setSpacing(10)
        self.horizontalLayout_202.setObjectName(u"horizontalLayout_202")
        self.horizontalLayout_202.setContentsMargins(0, 9, 0, 0)
        self.toolButton_102 = QToolButton(self.horizontalWidget_7)
...
"	border-radius: 0px;\n"
"}")
        self.toolButton_102.setIcon(icon3)
        ...
        self.verticalLayout_122 = QVBoxLayout(self.verticalWidget_4)
        ...
        self.verticalLayout_122.addWidget(self.posterboardLbl)

        self.verticalSpacer_23 = QSpacerItem(20, 16, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.verticalLayout_122.addItem(self.verticalSpacer_23)


        self.horizontalLayout_202.addWidget(self.verticalWidget_4)
        ...
        icon22 = QIcon()
        icon22.addFile(u":/icon/globe.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.findPBBtn.setIcon(icon22)
        self.findPBBtn.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)

        self.horizontalLayout_202.addWidget(self.findPBBtn)
        ...
        icon23 = QIcon()
        icon23.addFile(u":/icon/questionmark.circle.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pbHelpBtn.setIcon(icon23)
        self.pbHelpBtn.setIconSize(QSize(20, 20))

        self.horizontalLayout_202.addWidget(self.pbHelpBtn)
...
"}")
        ...
        self.pbSetupPageBtn.setIcon(icon11)
        ...
        icon24 = QIcon()
        icon24.addFile(u":/icon/file-earmark-zip.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.tendiesPageBtn.setIcon(icon24)
        ...
        self.templatePageBtn.setIcon(icon25)
        ...
        self.line_122 = QFrame(self.posterboardPage)
...
"}")
        ...
        self.verticalLayout_143.addWidget(self.line_122)
...
"}")
        ...
        self.label_681 = QLabel(self.pbApplyMethods)
        self.label_681.setObjectName(u"label_681")
        self.label_681.setMaximumSize(QSize(150, 16777215))

        self.horizontalLayout_38.addWidget(self.label_681)
        ...
        self.label_671 = QLabel(self.configOptions)
        self.label_671.setObjectName(u"label_671")
        self.label_671.setEnabled(False)

        self.horizontalLayout_31.addWidget(self.label_671)
...
"}")
        icon27 = QIcon()
        icon27.addFile(u":/icon/trash.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.removeSelectedIdBtn.setIcon(icon27)
...
"}")
        ...
        self.horizontalLayout_203 = QHBoxLayout(self.horizontalWidget_5)
        ...
        self.toolButton_103 = QToolButton(self.horizontalWidget_5)
...
"	border-radius: 0px;\n"
"}")
        self.toolButton_103.setIcon(icon25)
        ...
        self.verticalLayout_123 = QVBoxLayout(self.verticalWidget_10)
        ...
        self.verticalLayout_123.addWidget(self.templatesLbl)

        self.verticalSpacer_24 = QSpacerItem(20, 16, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.verticalLayout_123.addItem(self.verticalSpacer_24)


        self.horizontalLayout_203.addWidget(self.verticalWidget_10)
        ...
        self.verticalLayout_144.addWidget(self.horizontalWidget_5)

        self.line_123 = QFrame(self.templatesPage)
...
"}")
        ...
        self.verticalLayout_144.addWidget(self.line_123)
...
"}")
        ...
        self.verticalLayout_144.addLayout(self.verticalLayout_383)
        ...
        self.verticalLayout_145 = QVBoxLayout(self.passcodeThemesPage)
        ...
        self.horizontalLayout_204 = QHBoxLayout(self.horizontalWidget_19)
        ...
        self.toolButton_104 = QToolButton(self.horizontalWidget_19)
...
"	border-radius: 0px;\n"
"}")
        self.toolButton_104.setIcon(icon7)
        ...
        self.verticalLayout_124 = QVBoxLayout(self.verticalWidget_19)
        ...
        self.verticalLayout_124.addWidget(self.passcodeThemesLbl)

        self.verticalSpacer_241 = QSpacerItem(20, 16, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.verticalLayout_124.addItem(self.verticalSpacer_241)


        self.horizontalLayout_204.addWidget(self.verticalWidget_19)
        ...
        self.discoverPassthmBtn.setIcon(icon22)
        self.discoverPassthmBtn.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)

        self.horizontalLayout_204.addWidget(self.discoverPassthmBtn)


        self.verticalLayout_145.addWidget(self.horizontalWidget_19)

        self.line_124 = QFrame(self.passcodeThemesPage)
...
"}")
        ...
        self.verticalLayout_145.addWidget(self.line_124)

        self.verticalSpacer_13 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Preferred)

        self.verticalLayout_145.addItem(self.verticalSpacer_13)
        ...
        sizePolicy5.setHeightForWidth(self.keySizeDrp.sizePolicy().hasHeightForWidth())
        self.keySizeDrp.setSizePolicy(sizePolicy5)
        self.keySizeDrp.setMinimumSize(QSize(100, 0))

        self.horizontalLayout_26.addWidget(self.keySizeDrp)


        self.verticalLayout_145.addLayout(self.horizontalLayout_26)

        self.verticalLayout_691 = QVBoxLayout()
        self.verticalLayout_691.setObjectName(u"verticalLayout_691")
        self.verticalLayout_691.setContentsMargins(-1, -1, -1, 0)
        self.label_62 = QLabel(self.passcodeThemesPage)
        self.label_62.setObjectName(u"label_62")
        self.label_62.setText(u"Language Code")

        self.verticalLayout_691.addWidget(self.label_62)
        ...
        self.verticalLayout_691.addWidget(self.passthmLanguageCodeTxt)


        self.verticalLayout_145.addLayout(self.verticalLayout_691)
        ...
        self.verticalLayout_145.addWidget(self.label_60)
        ...
        self.verticalLayout_145.addWidget(self.selectedPassthmLbl)
        ...
        self.importPassthmBtn.setIcon(icon28)
        ...
        self.verticalLayout_145.addLayout(self.verticalLayout_384)
        ...
        self.horizontalLayout_205 = QHBoxLayout(self.horizontalWidget_9)
        ...
        self.toolButton_105 = QToolButton(self.horizontalWidget_9)
...
"	border-radius: 0px;\n"
"}")
        self.toolButton_105.setIcon(icon13)
        ...
        self.verticalLayout_125 = QVBoxLayout(self.verticalWidget_8)
        ...
        self.verticalLayout_125.addItem(self.verticalSpacer_182)


        self.horizontalLayout_205.addWidget(self.verticalWidget_8)
        ...
        self.verticalLayout_146.addWidget(self.horizontalWidget_9)
...
"}")
        ...
        self.verticalLayout_146.addWidget(self.line_125)
...
"}")
        ...
        self.verticalLayout_132.addItem(self.verticalSpacer_6)


        self.verticalLayout_146.addWidget(self.advancedOptionsPageContent)

        self.pages.addWidget(self.advancedOptionsPage)
        self.tweaksPage = QWidget()
        self.tweaksPage.setObjectName(u"tweaksPage")
        self.verticalLayout_6 = QVBoxLayout(self.tweaksPage)
        self.verticalLayout_6.setObjectName(u"verticalLayout_6")
        self.verticalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.verticalWidget = QWidget(self.tweaksPage)
...
"}")
        ...
        self.springboardOptionsPageBtn.setIcon(icon19)
        ...
        self.internalOptionsPageBtn.setIcon(icon20)
        ...
        self.liquidGlassPageBtn.setIcon(icon21)
        ...
        self.pages.addWidget(self.tweaksPage)
...
"}")
    ...
    def retranslateUi(self, Nugget):
        ...
        self.tweaksPageBtn.setText(QCoreApplication.translate("Nugget", u"    Tweaks", None))
...
"Please do not make GitHub issues on Nugget about them, it is not fixable.", None))
        ...
        self.label_651.setText(QCoreApplication.translate("Nugget", u"Disable Liquid Glass on Buttons", None))
        self.label_661.setText(QCoreApplication.translate("Nugget", u"Disable Liquid Glass on Lock Screen", None))
        ...
        self.label_681.setText(QCoreApplication.translate("Nugget", u"Apply Method:", None))
        ...
        self.label_671.setText(QCoreApplication.translate("Nugget", u"Saved Ids:", None))
...
"Warning: Disabling will cause the battery to show \"Unknown Part\" or \"Unverified\" in Settings.", None))
        ...
        self.statusBarLbl_5.setText(QCoreApplication.translate("Nugget", u"Tweaks", None))
